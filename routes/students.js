...
router.post("/", (req, res) => {
    ...
    const icourse = req.body.course_name;
    const idept = req.body.department_name;
    const iinstructor=req.body.instructor_id;
    const sqlQuery = `
    INSERT INTO ${tables.tableNames.student}
    (name, course_name, department_name,instructor_id)
    VALUES ('${iname}', '${icourse}', '${idept}',${iinstructor})`;
